      ...
      function StatisticsDecorator(objectToDecorate, decoratedParent) {
        ...
        function getStatus() {
          ...
          if (decoratedObject.failed > 0) {
            ...
            status = 'warning';
          } else if (decoratedObject.conditional > 0) {
            status = 'conditional';
          }
          return status;
        }
        ...
        function conditional() {
          decoratedObject.total++;
          decoratedObject.conditional++;
          if (decoratedParentReference && decoratedParentReference.conditional) {
            decoratedParentReference.conditional();
          }
        }
